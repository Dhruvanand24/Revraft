...
export const {
    ...
    utils:{
        ...
        "imgBg":()=>({
            width:"100%",
            height:"100%",
            backgroundImage:"url('https://png.pngtree.com/thumb_back/fh260/background/20230613/pngtree-pink-room-with-many-plants-and-posters-for-walls-image_2949296.jpg')",
